...
-- CreateIndex
CREATE INDEX "Post_legacyUrl_idx" ON "Post"("legacyUrl");

-- CreateIndex
CREATE UNIQUE INDEX "Post_legacySource_legacyId_key" ON "Post"("legacySource", "legacyId");
...
-- CreateIndex
CREATE UNIQUE INDEX "MediaAsset_legacyUrl_key" ON "MediaAsset"("legacyUrl");
